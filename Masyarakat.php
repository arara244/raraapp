...
class Masyarakat extends CI_Controller {
    ...
    public function registrasi(){
     ...
     public function registrasi_user(){
        ...
        //jika form validation bermasalah maka dikembalikan ke metho registrasi dengan pesan error
        ...
        if($this->M_masyarakat->tambahMasyarakat($data)){
            ...
            //jia tidak bermasalah maka simpan ke database 
        } 
        ...
        public function login(){
            ...
            //jika form validasi bermaslah maka dikembalikan ke method index dengan pesan error
            if($this->form_validation->run()==FALSE){
                $this->index();
            }else{
                $pass=md5($_POST['password']);
            ...
            //jika username dan passwordditemukan maka set session
            //tampikan method index
        }
